// ==Bookmarklet Script==
// @name         OpenPhone AI Summarizer (Fully Restored & Stable)
...
(() => {
    ...
    const BASE_PROMPT_HEADER = `Goal:\nTransform a potentially messy conversation log...`; // Abridged for clarity
    const BASE_PROMPT_FOOTER = `? How I Work:\nSynthesize & Consolidate...`; // Abridged for clarity
    ...
    const injectStyles=()=>{const e="gemini-summarizer-styles";if(document.getElementById(e))return;const t=document.createElement("style");t.id=e;t.innerHTML=`
            ...
            .gemini-modal-button:hover { background-color: #e0e0e0; } .gemini-modal-button.primary { background-color: #007bff; color: white; border-color: #007bff; }
    ...
    const runSummaryProcess = async (modelName, selectedSections, customInstructions, dateFilter) => {
        ...
        try {
            ...
            let imagePayloads = [], imageActivities = openPhoneData.result.filter(e => e.media?.some(e => e.type.startsWith("image/")));
    ...
    console.log("🚀 Initializing OpenPhone AI Summarizer v36...");
    injectStyles();
